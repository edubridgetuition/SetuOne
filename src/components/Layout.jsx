...
const s = {
  ...
  launcherButtonActive: { background: "rgba(255, 255, 255, 0.15)" },
  dotGrid: { width: "10px", display: "grid", gridTemplateColumns: "repeat(3, 3px)", gap: "2px" },
  gridDot: { width: "3px", height: "3px", borderRadius: "50%", background: "#ffffff" },
  ...
  tenantName: { fontSize: "11px", fontWeight: 700, color: "#e0f2fe" },
  userChip: { display: "flex", alignItems: "center", gap: "8px" },
  userAv: { width: "30px", height: "30px", borderRadius: "50%", background: "#0038a8", color: "#fff", border: "1.5px solid rgba(255, 255, 255, 0.8)", fontSize: "11px", fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center" },
  userName: { fontSize: "12px", fontWeight: 800, color: "#ffffff" },
  userRole: { fontSize: "10px", color: "#cbd5e1" },
  logoutBtn: { background: "rgba(255, 255, 255, 0.08)", border: "1px solid rgba(255, 255, 255, 0.25)", borderRadius: "6px", padding: "6px 10px", fontSize: "12px", color: "#ffffff", cursor: "pointer" },
